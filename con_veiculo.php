          ...
          echo("
          	<div class='col-sm-6 col-md-4'>
            	<div class='thumbnail'> 
                  ...
                  <form method='POST' action='con_veiculo_detalhe.php' class='form-inline'>
                    <input type='hidden' name='id' value='$id'>
                    <div class='form-group' id='div-veiculo'>
                      <button type='submit' class='btn btn-primary'><span class='glyphicon glyphicon-th-list' aria-hidden='true'></span> Detalhar</button>
                    </div>
                  </form>
