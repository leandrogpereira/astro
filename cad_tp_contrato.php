    ...
    <div class="container theme-showcase" role="main">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">PARA CADASTRAR UM NOVO TIPO DE CONTRATO, PREENCHA O FORMULÁRIO COM OS DADOS SOLICITADOS:</h3>
        </div>
          <div class="panel-body">
            <form method="POST" action="cad_tp_contrato.php">
              <div class="row">
                <div class="col-xs-6 col-md-4">
                  <br>Tipo de Contrato:<br>
                  <input type="text" placeholder="Ex: Comum" class="form-control" name="tp_contrato" maxlength="45" required>
                </div>
              </div>
                <br><br><br>
...
<?php
  ...
  $res = mysql_query("INSERT INTO tp_contrato VALUES (NULL,'$tp_contrato');"); 
