...
<div class="tudo">
	...
	<div class="conteudo">
			...
			<?php
					...
					if ($_SESSION["acesso"] <= 1 || $_GET["id_lancamento"] == null)
					{
					echo "
							...
							echo "
								<div class='container theme-showcase' role='main'>
									<div class='panel panel-success'> 
										<div class='panel-heading'><h3 class='panel-title'>Aviso</h3></div> 
										<div class='panel-body'> Lançamento removido com sucesso!<br><br><a href='ger_lancamento.php'><button type='button' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span> Voltar</button></a></div> 
									</div>
								</div>
							";
							mysql_close($conecta);
