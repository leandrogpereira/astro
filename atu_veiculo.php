          ...
          <div class="container theme-showcase" role="main">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title">PARA ATUALIZAR UM VEÍCULO, PREENCHA O FORMULÁRIO COM OS DADOS SOLICITADOS:</h3>
              </div>
                ...
                <form method="POST" action="atu_veiculo.php" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-xs-6 col-md-4">
                      <br>UF da Placa:<br>
                      <input type="text" placeholder="Ex: SP" class="form-control" name="placa_uf" maxlength="2" value=<?php echo (" '$placa_uf'"); ?>>
                    </div>

                    <div class="col-xs-6 col-md-4">
                      <br>Município da Placa:<br>
                      <input type="text" placeholder="Ex: Pindamonhangaba" class="form-control" name="placa_mun" maxlength="80" value=<?php echo (" '$placa_mun'"); ?>>
                    </div>

                    <div class="col-xs-6 col-md-4">
                      <br>Número da Placa:<br>
                      <input type="text" placeholder="Ex: FKB7532" class="form-control" name="placa_cod" maxlength="7" value=<?php echo (" '$placa_cod'"); ?>>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-xs-6 col-md-4">
                      <br>Modelo:<br>
                      <input type="text" placeholder="Ex: VM 260 - Semipesado" class="form-control" name="modelo" maxlength="45" value=<?php echo (" '$modelo'"); ?>>
                    </div>

                    <div class="col-xs-6 col-md-4">
                      <br>Marca:<br>
                      <input type="text" placeholder="Ex: Volvo" class="form-control" name="marca" maxlength="45" value=<?php echo (" '$marca'"); ?>>
                    </div>

                    <div class="col-xs-6 col-md-4">
                      <br>Ano:<br>
                      <input type="text" placeholder="Ex: 2016" class="form-control" name="ano" maxlength="4" onkeypress='return SomenteNumero(event)' value=<?php echo (" '$ano'"); ?>>
                    </div>
                  </div>
