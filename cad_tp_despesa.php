...
<?php
      ...
      <div class="container theme-showcase" role="main">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">PARA CADASTRAR UM NOVO TIPO DE DESPESA, PREENCHA O FORMULÁRIO COM OS DADOS SOLICITADOS:</h3>
          </div>
            <div class="panel-body">
              <form method="POST" action="cad_tp_despesa.php">
                <div class="row">
                  <div class="col-xs-6 col-md-4">
                    <br>Tipo de Despesa:<br>
                    <input type="text" placeholder="Ex: Comum" class="form-control" name="tp_despesa" maxlength="45" required>
                  </div>
                </div>
                  <br><br><br>
  ...
  <?php
   ...
   else
   {
      ...
      $res = mysql_query("INSERT INTO tp_despesas VALUES (null,'$tp_despesa',1);"); 
      ...
      if(mysql_affected_rows()>0)
      {
        ...
        <div class='container theme-showcase' role='main'>
          <div class='panel panel-success'> 
            <div class='panel-heading'><h3 class='panel-title'>Aviso</h3></div> 
            <div class='panel-body'> Item cadastrado com sucesso!<br><br><a href='cad_tp_despesa.php'><button type='button' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span> Voltar</button></a></div> 
          </div>
        </div>
        ";
        mysql_close($conecta);
