    ...
    <div class="container theme-showcase" role="main">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">RELATÓRIO DE DESPESAS:</h3>
        </div>
        <div class="panel-body">
          <h4 class="panel-title">Selecione as opções para filtrar sua consulta e clique no botão:</h4>
          <br>

          <form method="POST" target="_blank" action="emi_despesa.php">
          
          <div class="row">

            <div class="col-md-2">
              <label for="campoData">Data inicial:</label>
              <input type="text" id="campoData" placeholder="Ex.: 01-01-2010" class="form-control" name="dt_inicio" value="01/01/2010" autofocus="" required>
            </div>

            <div class="col-md-2">
              <label for="campoData1">Data final:</label>
              <input type="text" id="campoData1" placeholder="Ex.: 01-01-2018" class="form-control" name="dt_fim" value="01/01/2018" required>
            </div>
